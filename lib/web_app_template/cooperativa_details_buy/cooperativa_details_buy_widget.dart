...
import 'cooperativa_details_buy_model.dart';
export 'cooperativa_details_buy_model.dart';

class CooperativaDetailsBuyWidget extends StatefulWidget {
  const CooperativaDetailsBuyWidget({
    super.key,
  ...
  @override
  State<CooperativaDetailsBuyWidget> createState() =>
      _CooperativaDetailsBuyWidgetState();
}

class _CooperativaDetailsBuyWidgetState
    extends State<CooperativaDetailsBuyWidget> {
  late CooperativaDetailsBuyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CooperativaDetailsBuyModel());
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    ScaffoldMessenger.of(
                                                      ...
                                                      SnackBar(
                                                        content: const Text(
                                                          'Interesse de compra registrado com sucesso.',
                                                          style: TextStyle(
                                                            color: Colors.white,
                                                          ),
                                                        ),
