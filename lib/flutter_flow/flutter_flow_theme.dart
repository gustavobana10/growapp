...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF33604C);
  late Color secondary = const Color(0xFFF3E28C);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFFFAE1);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFF1F1F1);
  late Color accent1 = const Color(0x4C34A853);
