...
class _FormularioWidgetState extends State<FormularioWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await currentUserReference!.update({
        ...createUsersRecordData(
          quantidadesSafras: _model.quantidadeSafra,
        ),
        ...mapToFirestore(
          {
            'listaSafra': FieldValue.arrayUnion([
    ...
    _model.nomeFazendaController ??= TextEditingController();
          ...
          child: Column(
            ...
            children: [
              ...
              LinearPercentIndicator(
                percent: _model.pageViewCurrentIndex / 3,
                lineHeight: 12.0,
                animation: true,
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .nomeFazendaController,
                                                  focusNode: _model
                                                      .nomeFazendaFocusNode,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText:
                                                  ...
                                                  style: FlutterFlowTheme.of(
                                                      ...
                                                      .bodyMedium,
                                                  validator: _model
                                                      .nomeFazendaControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                        ...
                                        children: [
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 8.0),
                                                  child: Text(
                                                    'Selecione a quantidades de safras:',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                                                    ...
                                                    Expanded(
                                                      child:
                                                          FlutterFlowDropDown<
                                                              int>(
                                                        controller: _model
                                                                .quantidadeSafraValueController ??=
                                                            FormFieldController<
                                                                int>(
                                                          _model.quantidadeSafraValue ??=
                                                              1,
                                                        ),
                                                        ...
                                                        onChanged: (val) async {
                                                          setState(() => _model
                                                                  .quantidadeSafraValue =
                                                              val);
                                                          setState(() {
                                                            _model.quantidadeSafra =
                                                                _model
                                                                    .quantidadeSafraValue;
                                                          });
                                                        },
                                                        ...
                                                        textStyle:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .bodyMedium,
                                                        hintText:
                                                            'Selecione a quantidade de safras',
                                                        icon: Icon(
                                                          Icons
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              if (_model.tipoSafraModel1
                                                      .dropDownValue ==
                                                  null) {
                                                return;
                                              }
                                              if (_model.quantidadeSafraValue ==
                                                  1) {
                                                await currentUserReference!
                                                    .update({
                                                  ...mapToFirestore(
                                                    {
                                                      'listaSafra': FieldValue
                                                          .arrayUnion([
                                                        getSafraFirestoreData(
                                                          updateSafraStruct(
                                                            SafraStruct(
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(24.0, 16.0,
                                                          24.0, 0.0),
                                                  child: Text(
                                                    'Clique no botão abaixo para  selecionar a localização da fazenda',
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      if (_model
                                                        ...
                                                        ScaffoldMessenger.of(
                                                          ...
                                                          SnackBar(
                                                            content: Text(
                                                              'Escolha uma localização antes de salvar.',
                                                              style: TextStyle(
                                                                color: FlutterFlowTheme.of(
                                                                        context)
                                                                    .primaryText,
                          ...
                          child: Padding(
                            ...
                            child: smooth_page_indicator.SmoothPageIndicator(
                              ...
                              effect: smooth_page_indicator.SlideEffect(
                                ...
                                dotWidth: 8.0,
                                dotHeight: 8.0,
                                dotColor: const Color(0x5433604C),
                                activeDotColor:
